...
const deptData = {
    'nurani': {
        ...
        bg: 'bg-blue-100 text-blue-600',
        desc: `
            <p><b>বৈশিষ্ট্যসমূহ:</b></p>
            <ul class="mt-2 space-y-1">
                <li>• নার্সারি হতে তৃতীয় শ্রেণী পর্যন্ত নুরানী শিক্ষা</li>
                <li>• অভিজ্ঞ শিক্ষকদের দ্বারা শুদ্ধ তিলাওয়াত শিক্ষা</li>
                <li>• নূরে আলিফ, নূরে বসীরা সহ সর্বোত্তম পাঠ্যক্রম</li>
                <li>• খেলাধুলা ও অন্যান্য কার্যক্রম অন্তর্ভুক্ত</li>
            </ul>
        `
    },
    'ebtedayi': {
        ...
        desc: `
            <p><b>বৈশিষ্ট্যসমূহ:</b></p>
            <ul class="mt-2 space-y-1">
                <li>• চতুর্থ থেকে ৫ম শ্রেণী পর্যন্ত সাধারণ স্কুল কারিকুলাম</li>
                <li>• বাংলা, ইংরেজি, গণিত সহ সকল বিষয়</li>
                <li>• ইসলামি শিক্ষা ও নৈতিকতার বিশেষ জোর</li>
                <li>• সিসিএ কার্যক্রম এবং খেলাধুলার সুবিধা</li>
            </ul>
        `
    },
    'dakhil': {
        ...
        desc: `
            <p><b>বৈশিষ্ট্যসমূহ:</b></p>
            <ul class="mt-2 space-y-1">
                <li>• ৬ষ্ট থেকে অষ্টম শ্রেণী পর্যন্ত ইসলামি শিক্ষা</li>
                <li>• দাখিল বোর্ডের অনুমোদিত পাঠ্যক্রম অনুসরণ</li>
                <li>• ধর্মীয় ও বৈজ্ঞানিক জ্ঞানের সমন্বয়</li>
                <li>• ক্বারী ও মুফতি তৈরিতে বিশেষ প্রশিক্ষণ</li>
            </ul>
        `
    },
    'hifz-boy': {
        ...
        desc: `
            <p><b>বৈশিষ্ট্যসমূহ:</b></p>
            <ul class="mt-2 space-y-1">
                <li>• ছাত্রদের জন্য অভিজ্ঞ হাফেজদের তত্ত্বাবধানে হিফজ প্রশিক্ষণ</li>
                <li>• তাজবিদসহ সম্পূর্ণ কুরআন মেমোরাইজেশন</li>
                <li>• আধুনিক সুবিধা এবং শরীয়তি পরিবেশ</li>
                <li>• গড়ে ১-৩ বছরে হিফজ সম্পন্নকরণ</li>
            </ul>
        `
    },
    'hifz-girl': {
        ...
        desc: `
            <p><b>বৈশিষ্ট্যসমূহ:</b></p>
            <ul class="mt-2 space-y-1">
                <li>• ছাত্রীদের জন্য সম্পূর্ণ নিরাপদ ও শরীয়তি পরিবেশ</li>
                <li>• মহিলা শিক্ষকদের দ্বারা তিলাওয়াত শিক্ষা</li>
                <li>• কুরআন মেমোরাইজেশন প্রোগ্রাম</li>
                <li>• আধুনিক ও ঐতিহ্যবাহী শিক্ষার সংমিশ্রণ</li>
            </ul>
        `
    },
    'maktab': {
        ...
        desc: `
            <p><b>ভবিষ্যৎ পরিকল্পনা:</b></p>
            <ul class="mt-2 space-y-1">
                <li>• স্কুলগামী শিশুদের জন্য সকালে অথবা সন্ধ্যায় কোরআন শিক্ষা</li>
                <li>• মৌলিক ইসলামি শিষ্টাচার ও দুআ শিক্ষা</li>
                <li>• মাসআলা-মাসায়েল সহজভাবে শেখানো</li>
                <li>• নমনীয় সময়সূচী এবং সাশ্রয়ী ফি</li>
            </ul>
        `
    },
    'adult': {
        ...
        desc: `
            <p><b>বৈশিষ্ট্যসমূহ:</b></p>
            <ul class="mt-2 space-y-1">
                <li>• যেকোনো বয়সের কর্মজীবী ও প্রাপ্তবয়স্কদের জন্য কোরআন শিক্ষা</li>
                <li>• সহজ ও ব্যবহারিক পদ্ধতিতে শিক্ষা প্রদান</li>
                <li>• সন্ধ্যা এবং সপ্তাহান্তে ক্লাস পরিচালনা</li>
                <li>• বিশেষ চাহিদা অনুযায়ী কাস্টমাইজড প্রোগ্রাম</li>
            </ul>
        `
    }
};
...
const messages = {
    welcome: `
        <p class="font-bold text-blue-900 mb-2">বিসমিল্লাহির রাহমানির রাহিম</p>
        <p>সবাইকে আল-হারামাইন মডেল মাদ্রাসার ডিজিটাল ক্যাম্পাসে আন্তরিক শুভেচ্ছা ও স্বাগতম।</p>
        <p>শিক্ষার্থীদের সুন্দর ভবিষ্যৎ নিশ্চিত করতে এবং নৈতিকতা সম্পন্ন আদর্শ নাগরিক তৈরি করতে আমরা প্রতিশ্রুতিবদ্ধ।</p>
    `,
    director: `
        <p class="font-bold text-center text-emerald-800 mb-2">মাওলানা মোহাম্মদ জুনাইদ বোগদাদি</p>
        <p class="text-xs text-center text-gray-500 italic mb-3">পরিচালক, আল-হারামাইন মডেল মাদ্রাসা</p>
        <p>আলহামদুলিল্লাহ, দ্বীনি শিক্ষার এক অনন্য নির্ভরযোগ্য প্রতিষ্ঠান আল-হারামাইন মডেল মাদ্রাসা।</p>
        <p>আমাদের শিক্ষাক্রম সুবিন্যস্ত এবং ক্বারী ও হাফেজদের দ্বারা সরাসরি প্রশিক্ষণ দেওয়া হয়।</p>
    `,
    principal: `
        <p class="font-bold text-indigo-900 mb-2">সম্মানিত সুধী ও অভিভাবকবৃন্দ,</p>
        <p>আসসালামু আলাইকুম ওয়া রাহমাতুল্লাহ। একটি আদর্শ সমাজ বিনির্মাণে নৈতিক ও ধর্মীয় শিক্ষার ভূমিকা অপরিসীম।</p>
        <p>বিগত বছরগুলোতে সমাপনী পরীক্ষায় আমাদের শতভাগ পাসের হার এবং সরকারি-বেসরকারি বৃত্তিপ্রাপ্ত শিক্ষার্থীদের রয়েছে।</p>
    `
};